...
export default function Contacts() {
  ...
  const style = "ring hover:ring-2 transition-all duration-300 ease-in-out";
  return (
    <section
      id="contacts"
    ...
    >
      ...
      <form className="flex-1 min-w-1 w-full px-6 lg:pl-0 xl:pr-12 self-end">
        ...
        <div className="flex flex-col md:flex-row md:gap-4">
          <label className="flex flex-col flex-1 pb-2 min-w-1 text-sm ">
            ...
            <input
              type="text"
              className={`pl-2 placeholder:text-sm h-7 mt-1 focus:outline-0 focus:ring-stone-600 ${style}`}
        ...
        <div className="lg:mt-2 flex gap-4 flex-col sm:flex-row sm:items-end">
          <label className="flex-1 flex flex-col text-sm">
            ...
            <textarea
              type="email"
              className={`mt-1 h-13 focus:outline-0 focus:ring-stone-600 ${style}`}
            />
          </label>
          <Button
